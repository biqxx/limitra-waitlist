    ...
    <main>
      ...
      <section className="section" style={{ paddingTop: '20px' }}>
        <div className="container" style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'left' }}>
          <h1 style={{ fontSize: '2.5rem', marginBottom: '30px', color: 'var(--text-main)', textAlign: 'center' }}>Terms</h1>
          
          <div style={{ color: 'var(--text-muted)', lineHeight: '1.8', fontSize: '1.1rem', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <p>By joining the Limitra waitlist, you agree to these simple terms.</p>
            
            <p>The waitlist gives you the opportunity to receive early updates, launch news, and possible early access offers from Limitra.</p>
            
            <p>Joining the waitlist does not guarantee a product, discount, delivery slot, or confirmed launch date.</p>
            
            <p>Launch offers, pricing, availability, and membership access may change based on business needs, supplier availability, and official launch plans.</p>
            
            <p>You agree to provide accurate contact information when signing up.</p>
            
            <p>Limitra may remove duplicate, fake, or suspicious entries from the waitlist.</p>
            
            <p>You agree not to misuse the website, submit false information, or attempt to interfere with the waitlist system.</p>
            
            <p>Limitra may update these terms when needed. Continued use of the waitlist page means you accept the updated terms.</p>
          </div>
        </div>
      </section>
